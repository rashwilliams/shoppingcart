// const contentDiv = document.getElementById("shopping-cart");
// const increaseButton = document.getElementById("add-plus-btn");
// const reduceButton = document.getElementById("add-minus-btn");
// const likeButton = document.getElementById("add-heart-btn");
...
//     let viewBasket = document.createElement ("a")
...
//     viewTodoDetailsBtn.classList.add("btn");
//     viewTodoDetailsBtn.classList.add("btn-primary");
//     archiveBtn.classList.add("btn");
//     archiveBtn.classList.add("btn-warning");
//     archiveBtn.classList.add("move-right");
//   }
// }
...
// Add new Item Function || method
function addNewItem() {
  let addNewItem = Input.value;
  let reduceItem = Input.value;
}

// event listeners
addPlusButton.addEventListener("click", PlusButton);
addMinusButton.addEventListener("click", MinusButton);
addLikeButton.addEventListener ("click", LikeButton )
addViewBasketButton.addEventListener ("click", viewBasketButton)
openViewBasketButton.addEventListener ("click",viewBasketButton)
closeViewBasketButton.addEventListener("click", viewBasketButton);
